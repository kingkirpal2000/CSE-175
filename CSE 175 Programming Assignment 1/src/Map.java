...
public class Map {
	...
	public boolean promptForFilenames() {
		try {
			...
			buffer = in.readLine();
			buffer = "/Users/yogeshkirpal/Documents/CSE 175/CSE 175 Programming Assignment 1/src/small-locations.dat";
			setLocationFilename(buffer);
			//System.out.println("Enter the name of the road file:");
			buffer = in.readLine();
			buffer = "/Users/yogeshkirpal/Documents/CSE 175/CSE 175 Programming Assignment 1/src/small-roads.dat";
