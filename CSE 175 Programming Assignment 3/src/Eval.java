...
double near_win_scale = (float)(0.90);
...
eff_comp_brains_eaten += Math.round(blasts_scale * ((float)s.brains_collected));
} else {
eff_comp_brains_eaten += Math.round(no_blasts_scale *((float)s.brains_collected));
}
} else {
eff_user_brains_eaten += s.brains_collected;
}
} else {
if(s.current_choice == Choice.roll) {
if(s.blasts_collected > 0) {
eff_user_brains_eaten += Math.round(blasts_scale * ((float)s.brains_collected));
} else {
eff_user_brains_eaten += Math.round(no_blasts_scale *((float)s.brains_collected));
}
} else {
eff_user_brains_eaten += s.brains_collected;
}
}
if((eff_comp_brains_eaten > State.brains_to_win+1) || (eff_user_brains_eaten > State.brains_to_win)) {
